...
def middleCamFunc(frame, prevTime):
    global count2
    ...
    cv2.putText(frame, fpsStr, (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)

    frame = cv2.resize(frame, (261, 464))

    return frame, prevTime
